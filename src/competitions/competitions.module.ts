...
@Module({
    imports: [WalletModule, MongooseModule.forFeature([{name: Competition.name, schema: CompetitionSchema}, {name:Participant.name, schema:ParticipantSchema}, {name:AccountValue.name, schema:AccountValueSchema}])],
